...
class SecurityRAGService:
    ...
    def generate_response(self, query):
        ...
        keyword_rewrites = {
            ...
            "buffer overflow": "What is Buffer Overflow?",
            "what buffer overflow": "What is Buffer Overflow?",
            "dos": "What is Denial of Service (DoS)?",
            "ddos": "What is Distributed Denial of Service (DDoS)?",
            ...
            "insecure deserialization": "What is Insecure Deserialization?"
        }
        ...
        if query_norm in keyword_rewrites:
            ...
            # If not matching a rewrite and doesn't start with a question word, clean it up
            if not any(query_norm.startswith(word) for word in ["what", "how", "why", "who", "define", "explain"]):
        ...
        # 5. Format prompt using standard Q&A template
        prompt = (
            f"Context: {context}\n"
